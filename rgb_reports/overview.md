...
| W15 | `report_week15.md` | 06-01 → … | 11 | Representation vs introspection: the behavioral bridge. Every model 3B→32B *represents* Wonderful≈Awful as merged but *judges* them as opposite (sign-flip onto the human antonym value) — a localized read/write dissociation; symbolic valence overrides the associative geometry. Not size-gated. |
