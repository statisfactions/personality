...
| W18 | `report_week18.md` | 07-08 → … | 15 | Facet-level structure: 35 human-derived adjective clusters as facets (dashboard across HUMAN + 10 models × 3 channels); the disbelieved clusters — model judgment binds positive clusters but refuses human self-report's negative-halo bundles (valence = axis, not binder). SELF follow-ups queued. |
