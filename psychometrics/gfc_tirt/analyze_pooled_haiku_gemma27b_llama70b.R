#!/usr/bin/env Rscript
# Post-hoc analysis of the 3-model pooled fit:
...
fit_path <- "psychometrics/gfc_tirt/pooled_haiku_gemma27b_llama70b_fit.rds"
...
), "psychometrics/gfc_tirt/pooled_haiku_gemma27b_llama70b_summary.rds")
cat("\nSaved: psychometrics/gfc_tirt/pooled_haiku_gemma27b_llama70b_summary.rds\n")
