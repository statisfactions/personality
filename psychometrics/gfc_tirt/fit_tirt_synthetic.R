...
# Load response data (wide format) — synthetic personas
...
# Fit Stan TIRT — 400 respondents, use modest settings
cat("Fitting TIRT Stan model (cumulative family, 400 respondents)...\n")
cat("Using 2 chains x 1000 iter (500 warmup) to keep runtime reasonable\n\n")
...
# Save fit object
saveRDS(fit, "results/gemma2_gfc30_synthetic_tirt_fit.rds")
cat("Fit saved to results/gemma2_gfc30_synthetic_tirt_fit.rds\n\n")
...
# Also try simple scoring for comparison
