...
md += ["## Item-set provenance (compress to 1–2 sentences in the note)",
       ...
       "(instruments/trait_clusters.json, W18); JUDGE-nearest fallback "
       "for unclustered targets.",
       "- Anti-markers: most-negative entries of the target's row in the "
       "JUDGE similarity matrix AFTER removing its dominant "
       "(desirability) eigencomponent — raw anticorrelation just returns "
       "the desirability floor (evil/corrupt/…) for every positive "
       "target. One blocklisted outlier row.",
